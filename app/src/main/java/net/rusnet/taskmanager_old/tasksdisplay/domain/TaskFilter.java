package net.rusnet.taskmanager_old.tasksdisplay.domain;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import net.rusnet.taskmanager_old.commons.domain.model.Task;
import net.rusnet.taskmanager_old.commons.domain.model.TaskEndDate;
import net.rusnet.taskmanager_old.commons.domain.model.TaskType;
import net.rusnet.taskmanager_old.tasksdisplay.presentation.TaskViewType;
